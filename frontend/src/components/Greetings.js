...
const Greetings = forwardRef(({ setter }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className="bg-white flex flex-col-reverse items-center justify-center  md:flex-row font-racing text-darkTone max-w-screen-xl mx-auto pt-8 md:pt-28 md:pb-24 md:gap-16"
    >
